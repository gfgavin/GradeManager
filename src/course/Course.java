...
public class Course {
    ...
    public ArrayList<Assignment> distinctAssignments() {
        ArrayList<Assignment> distinctAssignments = new ArrayList<Assignment>();

        for(Assignment a : getAssignmentList())
        {
            boolean assignmentIsDistinct = true;
            for(Assignment a2 : distinctAssignments)
            {
                if(a.getAssignmentID() == a2.getAssignmentID())
                {
                    assignmentIsDistinct = false;
                }
            }
            if(assignmentIsDistinct)
            {
                distinctAssignments.add(a);
            }
        }
